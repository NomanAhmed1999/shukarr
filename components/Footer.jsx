        ...
        <footer className="bg-black text-white pt-14 pb-3">
            <Wrapper className="flex justify-between flex-col gap-[50px] md:gap-0">
                <div className="footer-top md:p-10 p-2 flex flex-row justify-between flex-wrap">
                    <div>
                        <h1 className="font-serif font-bold text-4xl">Don't Miss Out</h1>
                        <p>Subscribe for the latest news, product samples and coupons</p>
                        <p className="mt-8 text-lg">Email</p>
                        <Input size="medium" placeholder="abc@gmail.com" className="rounded-none" type="text" onChange={(e) => { setMail(e.target.value) }} />
                        <button
                        ...
                        <div className="mt-8 flex flex-row justify-around items-center flex-wrap">
                            ...
                            <div
                                onClick={() =>
                                    window.open("https://twitter.com/Shukarr_oficial", "_blank")
                                }
                                className="w-10 h-10 rounded-full border-2 border-white flex items-center justify-center text-black hover:bg-white/[0.2] cursor-pointer"
                            >
                            ...
                            <div
                                onClick={() =>
                                    window.open("https://www.youtube.com/@shukarr-official", "_blank")
                                }
                                className="w-10 h-10 rounded-full border-2 border-white flex items-center justify-center text-black hover:bg-white/[0.2] cursor-pointer"
                            >
                            ...
                            <div
                                onClick={() =>
                                    window.open("https://web.whatsapp.com/wa.me/+923209224569", "_blank")
                                }
                                className="w-10 h-10 rounded-full border-2 border-white flex items-center justify-center text-black hover:bg-white/[0.2] cursor-pointer"
                            >
                    ...
                    <div className="mt-10 md:mt-0">
                        <div>
                            <h2 className="font-normal text-lg">Contact Us</h2>

                            <ul className="list-none md:mt-4 mt-2 leading-loose cursor-pointer">
                                <li className="text-gray-300">Phone Number: <strong>+923209224569</strong></li>
                                <li className="text-gray-300">Address: <strong>It's Online Store. Karachi Pakistan</strong></li>
                            </ul>
                        </div>
                    </div>
                </div>
